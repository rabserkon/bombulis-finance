...
public interface AccountService {
    ...
    <T extends Account> T createAccount(AccountDTO accountDTO, Long userId) throws CurrencyNonFound, NotFoundUser, AccountOtherType;
    <T extends Account> T deleteAccount(Long accountId, Long userId) throws AccountNonFound;
    <T extends Account> Collection<T> findUserAccounts(Long userId) throws AccountNonFound;
    <T extends Account> T editAccount(AccountEditDTO accountDTO, Long userId) throws CurrencyNonFound;
