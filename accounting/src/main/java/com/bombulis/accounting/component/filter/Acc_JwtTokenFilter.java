...
import com.bombulis.accounting.component.Acc_DefaultBearerTokenResolver;
...
@Component
public class Acc_JwtTokenFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public void setAuthenticationService(Acc_AuthenticationService authenticationService) {
