...
public final class CurrencyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.bombulis.stock.control.proto.Currency.CurrencyRequest,
      com.bombulis.stock.control.proto.Currency.CurrencyResponse> getGetCurrencyInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCurrencyInfo",
      requestType = com.bombulis.stock.control.proto.Currency.CurrencyRequest.class,
      responseType = com.bombulis.stock.control.proto.Currency.CurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.bombulis.stock.control.proto.Currency.CurrencyRequest,
      com.bombulis.stock.control.proto.Currency.CurrencyResponse> getGetCurrencyInfoMethod() {
    io.grpc.MethodDescriptor<com.bombulis.stock.control.proto.Currency.CurrencyRequest, com.bombulis.stock.control.proto.Currency.CurrencyResponse> getGetCurrencyInfoMethod;
      ...
      synchronized (CurrencyServiceGrpc.class) {
        if ((getGetCurrencyInfoMethod = CurrencyServiceGrpc.getGetCurrencyInfoMethod) == null) {
          CurrencyServiceGrpc.getGetCurrencyInfoMethod = getGetCurrencyInfoMethod = 
              io.grpc.MethodDescriptor.<com.bombulis.stock.control.proto.Currency.CurrencyRequest, com.bombulis.stock.control.proto.Currency.CurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.bombulis.accounting.proto.CurrencyService", "GetCurrencyInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bombulis.stock.control.proto.Currency.CurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bombulis.stock.control.proto.Currency.CurrencyResponse.getDefaultInstance()))
  ...
  public static abstract class CurrencyServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCurrencyInfo(com.bombulis.stock.control.proto.Currency.CurrencyRequest request,
        io.grpc.stub.StreamObserver<com.bombulis.stock.control.proto.Currency.CurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.bombulis.stock.control.proto.Currency.CurrencyRequest,
                com.bombulis.stock.control.proto.Currency.CurrencyResponse>(
  ...
  public static final class CurrencyServiceBlockingStub extends io.grpc.stub.AbstractStub<CurrencyServiceBlockingStub> {
    ...
    /**
     */
    public com.bombulis.stock.control.proto.Currency.CurrencyResponse getCurrencyInfo(com.bombulis.stock.control.proto.Currency.CurrencyRequest request) {
  ...
  public static final class CurrencyServiceFutureStub extends io.grpc.stub.AbstractStub<CurrencyServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bombulis.stock.control.proto.Currency.CurrencyResponse> getCurrencyInfo(
        com.bombulis.stock.control.proto.Currency.CurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CURRENCY_INFO:
          serviceImpl.getCurrencyInfo((com.bombulis.stock.control.proto.Currency.CurrencyRequest) request,
              (io.grpc.stub.StreamObserver<com.bombulis.stock.control.proto.Currency.CurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CurrencyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bombulis.stock.control.proto.Currency.getDescriptor();
    }
