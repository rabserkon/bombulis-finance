...
public final class TransactionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.bombulis.stock.control.proto.Transaction.TransactionRequest,
      com.bombulis.stock.control.proto.Transaction.TransactionResponse> getDebitMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Debit",
      requestType = com.bombulis.stock.control.proto.Transaction.TransactionRequest.class,
      responseType = com.bombulis.stock.control.proto.Transaction.TransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.bombulis.stock.control.proto.Transaction.TransactionRequest,
      com.bombulis.stock.control.proto.Transaction.TransactionResponse> getDebitMethod() {
    io.grpc.MethodDescriptor<com.bombulis.stock.control.proto.Transaction.TransactionRequest, com.bombulis.stock.control.proto.Transaction.TransactionResponse> getDebitMethod;
      ...
      synchronized (TransactionServiceGrpc.class) {
        if ((getDebitMethod = TransactionServiceGrpc.getDebitMethod) == null) {
          TransactionServiceGrpc.getDebitMethod = getDebitMethod = 
              io.grpc.MethodDescriptor.<com.bombulis.stock.control.proto.Transaction.TransactionRequest, com.bombulis.stock.control.proto.Transaction.TransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.bombulis.accounting.proto.TransactionService", "Debit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bombulis.stock.control.proto.Transaction.TransactionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bombulis.stock.control.proto.Transaction.TransactionResponse.getDefaultInstance()))
  ...
  public static abstract class TransactionServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void debit(com.bombulis.stock.control.proto.Transaction.TransactionRequest request,
        io.grpc.stub.StreamObserver<com.bombulis.stock.control.proto.Transaction.TransactionResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.bombulis.stock.control.proto.Transaction.TransactionRequest,
                com.bombulis.stock.control.proto.Transaction.TransactionResponse>(
                  this, METHODID_DEBIT)))
          .build();
    }
  }
  ...
  public static final class TransactionServiceBlockingStub extends io.grpc.stub.AbstractStub<TransactionServiceBlockingStub> {
    ...
    /**
     */
    public com.bombulis.stock.control.proto.Transaction.TransactionResponse debit(com.bombulis.stock.control.proto.Transaction.TransactionRequest request) {
  ...
  public static final class TransactionServiceFutureStub extends io.grpc.stub.AbstractStub<TransactionServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bombulis.stock.control.proto.Transaction.TransactionResponse> debit(
        com.bombulis.stock.control.proto.Transaction.TransactionRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DEBIT:
          serviceImpl.debit((com.bombulis.stock.control.proto.Transaction.TransactionRequest) request,
              (io.grpc.stub.StreamObserver<com.bombulis.stock.control.proto.Transaction.TransactionResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TransactionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bombulis.stock.control.proto.Transaction.getDescriptor();
    }
